...
public class CiLin {
	...
	public static void initCiLin(){
		...
		try {
			//初始化<关键词， 编号set>哈希
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream("src\\main\\resources\\cilindata\\keyWord_Identifier_HashMap.txt"), "utf-8"));// 读取文本
			...
			//初始化<第一层编号，高度>哈希
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream("src\\main\\resources\\cilindata\\first_KeyWord_Depth_HashMap.txt"), "utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null){
				strs = str.split(" ");
			...
			//初始化<前二层编号，高度>哈希
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream("src\\main\\resources\\cilindata\\second_KeyWord_Depth_HashMap.txt"), "utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null){
				strs = str.split(" ");
			...
			//初始化<前三层编号，高度>哈希
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream("src\\main\\resources\\cilindata\\third_KeyWord_Depth_HashMap.txt"), "utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null){
				strs = str.split(" ");
			...
			//初始化<前四层编号，高度>哈希
			inFile.close();
			inFile = new BufferedReader(new InputStreamReader(new FileInputStream("src\\main\\resources\\cilindata\\fourth_KeyWord_Depth_HashMap.txt"), "utf-8"));// 读取文本
			while ((str = inFile.readLine()) != null){
				strs = str.split(" ");
